...
/* Ported verbatim from the live compiled CSS. The live header is ~186px because
   ...
   over it — NOT a normal-flow stack of its children. .header's position:fixed is
...
/* Live CSS hides the hours block unconditionally — no min-width query re-enables it. */
...
<footer class="footer">
  <div class="container container-footer">
    {/* Column set verified against the live footer, not invented. Seven boxes:
        About Us, Services (CMS), Resources, PHONE, ADDRESS, EMAIL, HOURS. */}
    <div class="footer-grid-desktop">
      <div class="footer-box">
        ...
        <a class="footer-link" href="/photo-gallery">Photo Gallery</a>
      </div>
      <div class="footer-box">
      ...
      <div class="footer-box">
        ...
        <div class="footer-social">
          {socialLinks.map((s) => (
            <a class="social-icon-link" href={s.href} target="_blank" rel="noopener" aria-label={s.label}>
              <img src={`/icons/${s.icon}-white.svg`} alt="" width="20" height="20" loading="lazy" />
            </a>
          ))}
        </div>
      </div>
